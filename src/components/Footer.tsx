...
export const Footer = () => {
  return (
    <footer className="bg-white shadow border-t-2 dark:border-t-1 dark:border-gray-900 dark:bg-gray-900">
        <div className="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <Link to="/" className="hover:underline">John Clapper</Link></span>
